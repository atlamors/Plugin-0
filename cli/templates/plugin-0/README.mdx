...
> **Namespace:** [`@atla/plugin-0`](https://www.npmjs.com/package/@atla/plugin-0)  
...
- Subpath exports (optional)
  ...
  - Then import in apps as `import { MyWorkflow } from "@atla/plugin-0/workflows"`.
